...
var myChart = echarts.init(document.getElementById('oneHourHistory_enery'));
// 指定图表的配置项和数据
...
var refreshTime=startTime[lastIndex_1];
	...
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneHour_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/energy/"+"?starttime="+refreshTime,
				//url:currentUrl,
				success:function(res){
					...
					$("#oneHourHistory_enery_result").html(lastValue);
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneHour_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/energy/",
				async: false,
				success:function(res){
