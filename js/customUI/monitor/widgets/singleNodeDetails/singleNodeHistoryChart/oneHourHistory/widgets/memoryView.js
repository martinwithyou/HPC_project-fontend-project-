...
var myChart = echarts.init(document.getElementById('oneHourHistory_memory'));
// 指定图表的配置项和数据
...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneHour_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/memory/"+"?starttime="+refreshTime,
				//url:currentUrl,
				success:function(res){
					...
					$("#oneHourHistory_memory_result").html(lastValue);
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneHour_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/memory/",
				async: false,
				success:function(res){
