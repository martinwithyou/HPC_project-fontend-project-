...
var refreshTime=startTime[lastIndex_1];
	...
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneHour_network+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/network/"+"?starttime="+refreshTime,
...
function judgeWhichOne(timeObj,valueObj_0,valueObj_1,startTime,flag){
 ...
 function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneHour_network+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/network/",
				async: false,
				success:function(res){
