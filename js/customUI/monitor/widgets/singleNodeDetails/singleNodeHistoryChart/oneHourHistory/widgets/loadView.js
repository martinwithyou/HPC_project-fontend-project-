...
var refreshTime=startTime[lastIndex_1];
	...
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneHour_load+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/load/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneHour_load+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/load/",
				async: false,
				success:function(res){
