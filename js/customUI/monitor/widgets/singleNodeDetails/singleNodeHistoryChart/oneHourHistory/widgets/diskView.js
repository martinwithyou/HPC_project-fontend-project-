...
var myChart = echarts.init(document.getElementById('oneHourHistory_disk'));
// 指定图表的配置项和数据
...
var refreshTime=startTime[lastIndex_1];
	...
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneHour_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/disk/"+"?starttime="+refreshTime,
				//url:currentUrl,
				success:function(res){
					...
					$("#oneHourHistory_disk_result").html(lastValue);
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneHour_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/disk/",
				async: false,
				success:function(res){
