...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneDay_temperature+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/temperature/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneDay_temperature+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/temperature/",
				async: false,
				success:function(res){
