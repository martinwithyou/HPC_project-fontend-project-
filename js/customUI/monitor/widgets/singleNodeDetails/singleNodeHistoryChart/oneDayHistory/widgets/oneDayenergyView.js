...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneDay_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/energy/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneDay_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/energy/",
				async: false,
				success:function(res){
