...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneDay_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/disk/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneDay_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/disk/",
				async: false,
				success:function(res){
