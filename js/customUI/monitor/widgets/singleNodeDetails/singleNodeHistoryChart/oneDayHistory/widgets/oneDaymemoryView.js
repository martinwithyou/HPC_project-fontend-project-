...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneDay_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/memory/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneDay_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/memory/",
				async: false,
				success:function(res){
