...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneMonth_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/disk/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneMonth_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/disk/",
				async: false,
				success:function(res){
