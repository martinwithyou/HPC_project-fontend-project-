...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneMonth_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/energy/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneMonth_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/energy/",
				async: false,
				success:function(res){
