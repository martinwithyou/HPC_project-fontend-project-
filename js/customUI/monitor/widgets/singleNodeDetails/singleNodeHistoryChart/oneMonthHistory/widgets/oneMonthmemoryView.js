...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneMonth_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/memory/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneMonth_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/memory/",
				async: false,
				success:function(res){
