...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneMonth_temperature+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/temperature/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneMonth_temperature+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/temperature/",
				async: false,
				success:function(res){
