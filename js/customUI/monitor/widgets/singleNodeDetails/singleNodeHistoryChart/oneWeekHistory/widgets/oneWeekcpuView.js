...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneWeek_cpu+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/cpu/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneWeek_cpu+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/cpu/",
				async: false,
				success:function(res){
