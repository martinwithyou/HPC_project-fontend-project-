...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneWeek_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/memory/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneWeek_memory+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/memory/",
				async: false,
				success:function(res){
