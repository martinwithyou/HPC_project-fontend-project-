...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneWeek_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/disk/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneWeek_disk+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/disk/",
				async: false,
				success:function(res){
