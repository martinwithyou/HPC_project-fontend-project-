...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneWeek_temperature+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/temperature/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneWeek_temperature+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/temperature/",
				async: false,
				success:function(res){
