...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneWeek_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/energy/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneWeek_energy+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/energy/",
				async: false,
				success:function(res){
