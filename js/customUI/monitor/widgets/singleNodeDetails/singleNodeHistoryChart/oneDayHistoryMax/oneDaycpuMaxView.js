...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				//url:urlConstants.oneHour_cpu+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/cpu"+"?starttime="+startTime[lastIndex_1],
				url:urlConstants.oneDay_cpu+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/cpu/"+"?starttime="+refreshTime,
...
function firstTimeGetDataSuccessfully(){
           ...
           //	url:urlConstants.oneHour_cpu+"/"+Number($("#body").attr("data-node_id"))+"/tendency/hour/cpu",
           	url:urlConstants.oneDay_cpu+"/"+Number($("#body").attr("data-node_id"))+"/tendency/day/cpu/",
           	async:false,
           	success:function(res){
