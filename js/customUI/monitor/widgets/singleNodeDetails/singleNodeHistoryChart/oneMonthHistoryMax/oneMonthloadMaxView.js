...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneMonth_load+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/load/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneMonth_load+"/"+Number($("#body").attr("data-node_id"))+"/tendency/month/load/",
				async: false,
				success:function(res){
