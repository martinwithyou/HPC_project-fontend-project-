...
var refreshTime=startTime[lastIndex_1];
	function refreshChart(){
             ...
             $.ajax({
				type:"get",
				url:urlConstants.oneWeek_network+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/network/"+"?starttime="+refreshTime,
				//url:currentUrl,
...
function judgeWhichOne(timeObj,valueObj_0,valueObj_1,startTime,flag){
 ...
 function firstTimeGetDataSuccessfully(){
            ...
            $.ajax({
				type:"get",
				url:urlConstants.oneWeek_network+"/"+Number($("#body").attr("data-node_id"))+"/tendency/week/network/",
				async: false,
				success:function(res){
