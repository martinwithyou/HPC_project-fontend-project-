...
*/
define({
		selected_time:"Please select period：",
		hour:"Last an hour",
		day:"Yesterday",
		week:"Last 7 days",
		month:"Last 30 days",
		...
		job_b:"CPU core(s)",
		network_in_b:"Input",
		network_out_b:"Output",
		error:"Failed",
		text:["Load","Mean CPU (%)","Mean MEM (%)","Storage (%)","NET (K)","Energy (W)","Mean Temperature (℃)","Used core(s)"],
		type:["load","cpu","memory","disk","network","energy","temperature","job"],
		name:["load","CPU (%)","MEM (%)","Storage (%)","Net (K)","Energy (W)","Mean Temperature (℃)","Used core(s)"],
